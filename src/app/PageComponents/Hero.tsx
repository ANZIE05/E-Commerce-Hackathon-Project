...
const slides = [
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/images/1st-page-images/sofa.png", 
    lightImage: "/images/1st-page-images/light.png",
  },
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/images/1st-page-images/tortuga.png", 
    lightImage: "/images/1st-page-images/light.png", 
  },
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/images/1st-page-images/couch.png", 
    lightImage: "/images/1st-page-images/light.png", 
  },
];
  ...
  return (
    <section className="relative bg-[#F2F0FF] py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center">
        ...
        <Link
          href="#"
          className="inline-block bg-pink-500 text-white text-sm font-medium py-3 px-6 mt-6 hover:bg-pink-600 transition-all duration-300 w-1/3 text-center"
        >
          {current.buttonText}
        </Link>
      </div>
