...
const TopBar = () => {
  ...
  return (
    <div className="bg text-white py-2 text-sm flex items-center justify-center">
      {/* TopBar Container */}
      <div className="w-full max-w-[1200px] flex items-center justify-between px-4">
        ...
        <div className="flex items-center justify-center gap-6 w-full sm:w-auto">
          ...
          {/* Wishlist */}
          <a href="/wishlist" className="flex items-center gap-2 cursor-pointer hover:text-gray-800">
            <FaHeart />
            <span>Wishlist</span>
          </a>

          {/* Cart */}
          <a href="/cart" className="cursor-pointer hover:text-gray-800">
            <FaShoppingCart />
          </a>
        </div>
      </div>
